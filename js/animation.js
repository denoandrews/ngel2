...
function frameOne() {
	gsap.set([ '.isi, .f1, .gl' ], {autoAlpha:1});
	// gsap.set([ '#overlay-bg' ], {autoAlpha:0.3});
	gsap.set([ '#gl-ngenla-logo' ], {scale:0.49, x:-3, y:-59});

	shimmer()

	gsap.from(['#f1-copy1'], {duration:0.5, x: -30, delay:0.3, autoAlpha:0, ease: "power1.out"});
...
function frameThree() {
	...
	var delay = 3;
	gsap.to(['.f3, #lineImage'], {duration:0.5, delay:delay, autoAlpha:0});
	gsap.to(['#gl-ngenla-logo'], {duration:0.5, delay:delay, scale:1, x:0, y:0, ease: "power1.out"});
...
function sparkle(){
	gsap.set([ '#f4-sparkle1' ], {transformOrigin:"61px 121px"});
	gsap.set([ '#f4-sparkle2' ], {transformOrigin:"245px 107px"});
	gsap.set([ '#f4-sparkle3' ], {transformOrigin:"265px 113px"});
	gsap.set([ '#f4-sparkle4' ], {transformOrigin:"244px 129px"});
	...
	gsap.from(['#f4-sparkle4'], {duration:0.66, scale:0, delay:0.4, repeat: 3, repeatDelay:0.1, ease:Power3.easeInOut, yoyo:true});
...
function sparkleStop(){
	...
	gsap.to(['#f4-sparkle4'], {duration:1, delay:0.4, scale:1, ease:Power3.easeInOut});
}
